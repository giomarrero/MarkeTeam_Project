...
##variables with high rel.inf : AGE, DONATION_COUNT, AGE_NA, RESPONSE_RATE, DISTINCT_APPEAL_COUNT, 
#MOST_COMMON_GIFT_CHANNEL_PRO, AVG_DAYS_ACROSS_APPEALCODES,  TOTAL_AMOUNT_GIFTED_PRO, AMOUNT_GIFTED_LAST_YEAR, MAX_GIFT
...
sum(y1hat.train != true.y.train)/length(true.y.train)  ##Training error =  0.00770368
...
#Testing Set - TP: 0 FP: 0.007772053 TN: 0.9922279 FN: 0 
